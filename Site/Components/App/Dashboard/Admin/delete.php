...
<div class="position-absolute top-50 start-50 translate-middle">
    <h1><i class="fa-light fa-delete-left"></i> Excluir conta</h1><p class="lead">Certeza que apagar a conta <b><?=ucfirst($_GET['user'])?></b>?</p><a class="btn btn-outline-dark mb-3" href="dashboard.php?menu=users"><i class="fa-light fa-left-to-line"></i> Voltar</a><br>
    <form id = "form" action="./Components/Database/deleteSubmit.php" method="POST">
